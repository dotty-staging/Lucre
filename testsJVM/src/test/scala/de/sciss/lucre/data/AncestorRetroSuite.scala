...
import de.sciss.serial.{DataInput, DataOutput, TFormat, TReader, Writable, WritableFormat}
...
class AncestorRetroSuite extends AnyFeatureSpec with GivenWhenThen {
  ...
  val NUM1                      = if (TestUtil.isShort) 5000/4 else 5000 // 10000   // 4407 // 4407   // 10000 // 283 // 10000  // tree size in PARENT_LOOKUP
  val NUM2                      = if (TestUtil.isShort) 5500/4 else 5500 // 11000   // tree size in MARKED_ANCESTOR // 100000    // 150000

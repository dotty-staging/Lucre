...
object EditExprVar {
  def apply[T <: Txn[T], A, E[~ <: Txn[~]] <: Expr[~, A]](vr: E[T] & Var[T, E[T]], value: E[T])
  ...
  def applyDo[T <: Txn[T], A, E[~ <: Txn[~]] <: Expr[~, A]](vr: E[T] & Var[T, E[T]], value: E[T])
                                                           (implicit tx: T): Unit =
    vr() = value

  def applyUndo[T <: Txn[T], A, E[~ <: Txn[~]] <: Expr[~, A]](vr: E[T] & Var[T, E[T]], value: E[T])
  ...
  private final class Apply[T <: Txn[T], A, E[~ <: Txn[~]] <: Expr[~, A]](vr0: E[T] & Var[T, E[T]],
                                                                          value0: E[T], tx0: T)
